...
.controller('logincontroller', function($scope, $http, $state, store , $location , $window, $timeout, $ionicScrollDelegate, $rootScope) {
  ...
  $scope.testcruchdb = function(){
     $http.get("https://api.crunchbase.com/v/3/organizations?name=SkillSoft&page=1&user_key=43e29d431e62c74c0cbcc52a041cb875").success(function(res,req){
      console.log(res);
     });
  }
